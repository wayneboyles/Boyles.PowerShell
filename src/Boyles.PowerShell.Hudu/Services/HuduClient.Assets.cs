...
namespace Boyles.PowerShell.Hudu.Services
{
    public partial class HuduClient
    {
        ...
        /// </param>
        /// <returns>
        /// The asset, or <see langword="null"/> when it does not exist.
        /// </returns>
        public HuduAsset? GetAsset(int companyId, int assetId) => Sync(GetAssetAsync(companyId, assetId));
        ...
        /// </returns>
        public async Task<HuduAsset?> GetAssetAsync(int companyId, int assetId, CancellationToken cancellationToken = default)
        {
